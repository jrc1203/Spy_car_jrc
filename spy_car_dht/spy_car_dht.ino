//For small cars use mini l298n motor driver module
//or tb6612fng motor driver
//most importantly a battery eliminating circuit

//set your hotspot/wifi credentials according to the code ssid and pass
//for mobile hotspots use - wpa2 personal only mode and 2.4ghz
...
std::vector<MOTOR_PINS> motorPins = {
  ...
  { 14, 1, 3 },   //LEFT_MOTOR  Pins (EnB, IN3, IN4)
};
#define LIGHT_PIN 4
...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <td colspan=2 id="temperature">--&deg;C</td>
      </tr>
      <tr>
...
void loop() {
  ...
  if (millis() - lastDHTSend > 2000) {
    float temp = dhtsensor.readTemperature();
    float hum = dhtsensor.readHumidity();
    
    if (!isnan(temp) && !isnan(hum)) {
      String dhtData = "DHT," + String(temp) + "," + String(hum);
      wsCarInput.textAll(dhtData);
    }
    lastDHTSend = millis();
  }
}